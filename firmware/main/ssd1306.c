...
// void SSD1306_UpDateScreenInvert()
// {
// 	uint8_t temp = 0;
...
// 		{
// 			temp = reverseBits(SSD1306_Buffer[i * 128 + j]);
// 			SSD1306_Buffer[i * 128 + j] = reverseBits(SSD1306_Buffer[i * 128 + k]);
// 			SSD1306_Buffer[i * 128 + k] = temp;
// 			k--;
// 		}
// 	}
